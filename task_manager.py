...
def add_task():
    ...
    due_date = input("Due date of the task (in this format eg: 01 Jan 2020):")
            ...
            # Ask the user how to edit the task
                ...
                if user_tasks[select_task][5] == "No":
                    ...
                    if edit == "T" or edit == "t":
                        ...
                        new_date = input("New DUE DATE(in this format eg: 01 Jan 2020): ")
...
def generate_reports():
    ...
    user_t_incomplete_percent_dict = {}  # Determine % incompleted tasks
    ...
    for key in user_dict:
        ...
        user_t_incomplete_percent_dict[key] = round((user_dict[key] - user_t_complete_dict[key]) / total_tasks * 100)
